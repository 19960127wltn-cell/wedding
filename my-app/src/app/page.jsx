...
export default function MainPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-background text-foreground">
      <HomeNotice /> {/* Render HomeNotice Dialog/Drawer */}
      {/* Hero Section */}
      <section className="relative w-full h-[calc(100vh-3.5rem)] flex flex-col items-center justify-center text-center overflow-hidden pt-24 md:pt-32">
        ...
        <FadeInOnScroll className="relative z-20 p-4 flex flex-col items-center justify-center font-mj2 text-[30px] lg:text-[50px] text-white min-h-[300px]">
          <StaggeredTextReveal
          ...
          <HandwritingText className="mt-4" animate={showHandwritingText} />
        </FadeInOnScroll>
      </section>

...
function Command({
  ...
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn(
        "bg-popover text-popover-foreground flex h-full w-full flex-col overflow-hidden rounded-xl shadow-md",
        className
      )}
      {...props} />
  );
...
function CommandInput({
  ...
  return (
    <div
      ...
      className="flex h-9 items-center gap-2 border-b rounded-lg px-3">
